...
const projectPool = ref<ProjectItem[]>([
  ...
  },
  {
    ...
    summary: "从 0 到 1 独立打造的高并发玩家社区，累计 10W+ 注册用户，实现规模化盈利并持续运营至今。",
    url: "https://github.com/parallized",
    date: "2020 - 至今",
    stack: "Java / Redis 多级缓存 / 分布式架构 / UI UX 全套设计",
    roles: ["全栈开发", "产品设计", "后端开发"],
    tags: ["高并发治理", "商业闭环", "危机管控", "产品决策"],
    evidence: [
      "累计注册用户 10W+，峰值 DAU 2000+，月纯利 20k+，持续稳定运营 5 年+。",
      "通过 Redis 多级缓存与分布式拆分，在 DAU 2000+ 峰值下保持系统延迟 < 100ms。",
    ],
    star: {
      situation: "需要从零构建支撑万人规模的玩家社区，并在技术架构、产品设计与商业运营之间实现闭环。",
