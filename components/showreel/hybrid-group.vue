  ...
  <div class="hybrid-group">
    ...
    <div class="item">
      <div class="left-desc">
        ...
        <h2>
          和上一个同样酷的 C# WPF 音频流读取工具, 读取 .wav 并绘制输出频方曲线,
          CS61B 的作业
        </h2>
      </div>

      <QImg src="image/wavesound.webp" />
    </div>
...
.hybrid-group {
  @apply flex flex-col h-full pt-12 gap-8;
  ...
  .item {
    ...
    img {
      @apply w-1/2 rounded-lg h-[120px] aspect-video object-cover brightness-90;
    }
  }
}
